...
CREATE ROLE admin;
ALTER ROLE admin WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'md576fbb380b47521fc575b30ea37541553';
...
--
-- Name: personal; Type: DATABASE; Schema: -; Owner: admin
--

CREATE DATABASE personal WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';


ALTER DATABASE personal OWNER TO admin;
